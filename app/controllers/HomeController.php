...
class HomeController extends BaseController {
	...
	*/
	...
	public function getIndex()
	{
        ...
        $topSongs = fetch_rss("https://itunes.apple.com/jp/rss/topsongs/limit=20/xml")->items;
        $topAlbums = fetch_rss("https://itunes.apple.com/jp/rss/topalbums/limit=9/xml")->items;
